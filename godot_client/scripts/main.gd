...
@export_group("Bridge")
@export var bridge_url_binary := "http://127.0.0.1:8765/frame.bin"
@export var bridge_url_json := "http://127.0.0.1:8765/frame"
var bridge_url := bridge_url_binary

@export_group("World")
@export var seed := 42
@export var world_size := 192
@export var civ_count := 3

@export_group("View")
@export var view_tiles := 24
@export var stream_tiles := 64
