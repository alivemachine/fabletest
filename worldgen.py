...
# ---------------------------------------------------------------------------
# LAYER 0 (continuous) — WINDOWED value noise. The same tileable field as
# fractal_noise, but sampled over an ARBITRARY window [cx±span/2, cy±span/2]
# of the unit torus, at any zoom. This is what makes the world a pure function
# of *continuous* (x, y): the 512² grid is just one sampling of it.
#
